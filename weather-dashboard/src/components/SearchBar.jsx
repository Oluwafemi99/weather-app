...
const SearchBar = ({ onSearch }) => {
	...
	return (
		...
		>
			{/* City input */}
			<label className="text-2xl font-bold">Search Location</label>
			<input
				type="text"
				value={input}
				onChange={(e) => setInput(e.target.value)}
				placeholder=" 🔍Enter city name"
				className="flex-1 p-3 rounded-lg border border-blue-500 bg-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-400"
			/>
			{/* Submit button */}
			<button
				type="submit"
